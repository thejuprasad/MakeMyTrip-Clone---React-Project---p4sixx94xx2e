                ...
                <div ref={ticket} className="planeTicket_preview">
                    ...
                    <div className="details">
                        <div className="detail">
                            <p className="planeTicket_preview_text_primary">
                                Hotel
                            </p>
                            <p className="planeTicket_preview_text_secondary">
                                {hotel_name}
                            </p>
                        </div>
                        <div className="detail">
...
const Checkout = () => {
    ...
    const handlePay = () => {
        window.alert("your ticket have bee booked");
        navigate("/");
    };
    useEffect(() => {
            ...
            <div className="checkout_container">
                ...
                <form onSubmit={handleSubmit} className="payment_method">
                    ...
                    <div className="price_display_group">
                        ...
                        <p>
                            {guests
                                ? `${guests} * ${ticketPrice} = ${completePrice}`
                                : completePrice}
                        </p>
                    </div>
                    <div className="price_display_group">
                    ...
                    <div className="price_display_group">
                        ...
                        <div className="coupon_total">
                            {couponCode
                                ? Number(completePrice) + 1000 - 100
                                : Number(completePrice) + 1000}
                        </div>
                    </div>
                    <input
                        required
